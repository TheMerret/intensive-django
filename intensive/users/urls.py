...
urlpatterns = [
    ...
    django.urls.path(
        "signup-done", users.views.SignupDoneView.as_view(), name="signup-done"
    ),
    django.urls.path(
    ...
    django.urls.path(
        "users-list", users.views.UsersListView.as_view(), name="users-list"
    ),
    django.urls.path(
    ...
    django.urls.path(
        "profile-done",
        users.views.ProfileDoneView.as_view(),
        name="profile-done",
    ),
    django.urls.path(
